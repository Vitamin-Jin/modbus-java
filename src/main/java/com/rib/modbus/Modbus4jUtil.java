...
public class Modbus4jUtil {
	...
	public static void main(String[] args) {
		try {
			...
			Boolean v013 = readCoilStatus(1, 2);
...
//			System.out.println("v023:" + v023);
            ...
            // // 03测试
            //Number v031 = readHoldingRegister(1, 0, DataType.FOUR_BYTE_INT_UNSIGNED);// 注意,float
            // Number v032 = readHoldingRegister(1, 3,
            // DataType.FOUR_BYTE_FLOAT);// 同上
			//System.out.println("v031:" + v031);
			//System.out.println("v032:" + v032);
			
            //Number v033 = readHoldingRegister(1, 1, DataType.FOUR_BYTE_INT_UNSIGNED);// 注意,float
